...
static const char qt_meta_stringdata_ControlPanel[] = {
    "ControlPanel\0\0infoMsg(QString)\0"
    "updateTranslation()\0setSong(MPDSong)\0"
    "showCoverArtChanged(bool)\0updateVolume(int)\0"
};
...
void ControlPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->setSong((*reinterpret_cast< const MPDSong(*)>(_a[1]))); break;
        case 3: _t->showCoverArtChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->updateVolume((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void ControlPanel::infoMsg(QString _t1)
{
